...
// EXTERNAL MODULE: ./src/modules/initialPartical.js
var initialPartical = __webpack_require__(305);
;// CONCATENATED MODULE: ./src/modules/particles.js
...
/* harmony default export */ var particles = ({
  init: function init() {
    ...
    // console.log('initialPartical', pJSDom[0].pJS.particles);

    var btns = document.querySelectorAll('.header__switch-btn');
    var body = document.querySelector('body');
    btns.forEach(function (b) {
      b.addEventListener('click', function () {
        var mode = b.dataset.mode;
        if (mode === 'ligth') {
          body.classList.add("".concat(mode));
          pJSDom[0].pJS.particles.color.value = '#2855E0';
          pJSDom[0].pJS.particles.opacity.value = 0.5;
          pJSDom[0].pJS.particles.line_linked.color = '#252525';
          pJSDom[0].pJS.particles.line_linked.width = 5;
          pJSDom[0].pJS.particles.line_linked.opacity = 0.2;
          pJSDom[0].pJS.fn.particlesRefresh();
        } else {
          pJSDom[0].pJS.particles.color.value = "#B381E0";
          pJSDom[0].pJS.particles.opacity.value = 0.5;
          pJSDom[0].pJS.particles.line_linked.color = '#ffffff';
          pJSDom[0].pJS.particles.line_linked.width = 2;
          pJSDom[0].pJS.particles.line_linked.opacity = 0.2;
          pJSDom[0].pJS.fn.particlesRefresh();
...
/* harmony default export */ var slider = ({
  init: function init() {
    var swiper = new core('.swiper', {
      modules: [Pagination, Autoplay, EffectCards, Parallax],
      grabCursor: true,
      pagination: {
        el: '.swiper-pagination',
        type: 'bullets',
...
;// CONCATENATED MODULE: ./src/modules/lang.js
...
;// CONCATENATED MODULE: ./src/modules/mode.js
...
/* harmony default export */ var animation = ({
  init: function init() {
    ...
    var imgC = document.querySelector('.about__img._1');
    var imgC2 = document.querySelector('.about__img._2');
    gsapWithCSS.from(imgC, {
      scrollTrigger: {
        trigger: '.about',
        start: '-600 0'
        // scrub: true,
    ...
    gsapWithCSS.from('.features__title', {
      scrollTrigger: {
        trigger: '.features',
        start: '-600 0'
        // scrub: true,
    ...
    gsapWithCSS.from('.vision__title', {
      scrollTrigger: {
        trigger: '.vision',
        start: '-700 0'
        // scrub: true,
    ...
    gsapWithCSS.from('.business__title', {
      scrollTrigger: {
        trigger: '.business',
        start: '-700 0'
        // scrub: true,
    ...
    gsapWithCSS.from('.benefits__title', {
      scrollTrigger: {
        trigger: '.benefits',
        start: '-700 0'
        // scrub: true,
